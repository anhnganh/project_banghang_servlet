<%-- 
    Document   : cart
    Created on : Apr 29, 2021, 4:31:08 PM
    Author     : dochu
--%>
               ...
               <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><a class="remove" href="${pageContext.request.contextPath}/cart-delete?id=${item.product.id}"><fa class="fa fa-close"></fa></a></td>
                        <td><a href="${pageContext.request.contextPath}/product-detail?id=${item.product.id}"><img src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${item.product.image_link}" alt="img${item.product.name }"></a></td>
                        <td><a class="aa-cart-title" href="${pageContext.request.contextPath}/product-detail?id=${item.product.id}">${item.product.name }</a></td>
          			 ...
          			 <tr>
                        ...
                        <td><strong>${sumprice}000 VNĐ</strong></td>
                      </tr>
                      <tr>
