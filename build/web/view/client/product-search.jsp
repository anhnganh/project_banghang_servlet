<%-- 
    ...
    Created on : Apr 29, 2021, 3:46:07 PM
    Author     : dochu
--%>
                ...
                <c:forEach items="${productlist}" var="product">
	                ...
	                <li>
	                  <figure>
	                   ...
	                   <c:when test="${product.discount!=0}">
                                 <span class="aa-product-price">${product.price -product.price*product.discount/100}00VNĐ</span>    
        ...
        <div class="col-lg-3 col-md-3 col-sm-4 col-md-pull-9">
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <c:forEach items="${catalogList}" var="cate">
              	<li><a href="${pageContext.request.contextPath}/product-id?id=${cate.id}">${cate.name}</a></li>
              </c:forEach>                
              </ul>
            </div>
              ...
              <div class="aa-recently-views">
                <ul>
                 <c:forEach items="${productlist}" var="product" end="2">
                  <li>
                    <a href="${pageContext.request.contextPath}/product-detail?id=${product.id}" class="aa-cartbox-img"><img alt="img" src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}"></a>
                    <div class="aa-cartbox-info">
                      <h4><a href="${pageContext.request.contextPath}/product-detail?id=${product.id}">${product.name }</a></h4>
                      <c:choose>
                            <c:when test="${product.discount == 0}">
