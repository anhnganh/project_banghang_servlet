 ...
 * @author dochu
 */
@WebServlet(name = "ProductSeachByNameController", urlPatterns = {"/search"})
public class ProductSeachByNameController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("productlist", productSearchByName);
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/view/client/product-search.jsp");
